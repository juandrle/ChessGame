...
public class CalculationGameViewController extends ViewController<MonsterApplication> {
	...
	private final CalculatorGame calculationGame;
	...
	public CalculationGameViewController(CalculatorGame calculationGame, MonsterApplication application) {
		super(application);
	...
	public void initialize() {
		...
		processButton.addEventHandler(ActionEvent.ACTION, event -> processInput());
		...
		calculationGame.getCountCorrectAnswer().addListener((observable, oldValue, newValue) -> Platform.runLater(() -> score.setText("Score: " + newValue.toString())));
		...
		// punktestand: 0
		score.setText("Score: " + calculationGame.getHelpCountCorrectAnswer());
